...
st.set_page_config(page_title="Galpones", page_icon="🐥")
st.title("Datos del Galpon y sus condiciones climaticas")
st.sidebar.header("Mi Galpon")

st.write(
    """En este módulo se ingresarán los datos del galpón en el que se esta criando a los pollos de engorde 🐓 """)
