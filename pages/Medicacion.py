...
st.set_page_config(page_title="Medicación", page_icon="🔬")
st.title("Datos de la Medicación suministrada a la Camada")
st.sidebar.header("Faena")

st.write(
    """En este módulo se ingresarán los datos de los medicamentos suministrados a la camada y fecha de suministro 🚑""")
...
tables = {
    "medicacion": {
        "fecha": "date",
        "dosis": "integer",
        "cant_pollos_medicada": "integer"
    },
    "tipo_medicamento": {
        "tipo": "text"
    },
    "vias_aplicacion_medicacion": {
        "via": "text"
    }}
